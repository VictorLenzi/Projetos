...
restaurantes = [{'nome': 'Marusan', 'categoria': 'Pastel', 'ativo': False},
...
def cadastrar_novo_restaurante():
    ...
    Outputs:
    - Add um novo restaurante na lista de restaurante
...
def alternar_estado_restaurante():
    ...
    nome_restaurante = input(
        'Digite o nome do restuarante que deseja alterar o estado: ')
